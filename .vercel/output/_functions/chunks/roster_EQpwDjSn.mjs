...
const ROSTER_ENTRIES = [
  {
    ...
    heroImage: __ASTRO_IMAGE_IMPORT_Z1F4X4R.src,
  ...
  },
  {
    ...
    heroImage: __ASTRO_IMAGE_IMPORT_1NHVvs.src,
  ...
  },
  {
    ...
    heroImage: __ASTRO_IMAGE_IMPORT_ZulDpU.src,
  ...
  },
  {
    ...
    heroImage: __ASTRO_IMAGE_IMPORT_1inyCS.src,
  ...
  },
  {
    ...
    heroImage: __ASTRO_IMAGE_IMPORT_MGbyL.src,
  ...
  },
  {
    ...
    heroImage: __ASTRO_IMAGE_IMPORT_Z1Yq4sn.src,
...
const ROSTER_SLUGS = ROSTER_ENTRIES.map((entry) => entry.slug);
const getRosterEntryBySlug = (slug) => ROSTER_ENTRIES.find((entry) => entry.slug === slug);

export { ROSTER_SLUGS as R, ROSTER_ENTRIES as a, getRosterEntryBySlug as g };
