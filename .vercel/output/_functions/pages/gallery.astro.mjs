...
import { G as GALLERY_CATEGORIES } from '../chunks/galleryMedia_CTS_rLaz.mjs';
...
const $$Gallery = createComponent(($$result, $$props, $$slots) => {
  const categoryVisuals = {
    boudoir: {
      image: __ASTRO_IMAGE_IMPORT_ZulDpU,
      mood: "Warm editorial silhouettes and confident direction."
    },
    "artistic-nude": {
      image: __ASTRO_IMAGE_IMPORT_1inyCS,
      mood: "Fine-art composition focused on form, light, and shape."
    },
    "body-paint": {
      image: __ASTRO_IMAGE_IMPORT_Z1F4X4R,
      mood: "Color-washed texture and body-art storytelling."
    },
    "editorial-portrait": {
      image: __ASTRO_IMAGE_IMPORT_MGbyL,
      mood: "Brand-safe portraiture with cinematic styling and polish."
    }
  };
  const featuredStrip = [__ASTRO_IMAGE_IMPORT_Z1F4X4R, __ASTRO_IMAGE_IMPORT_1NHVvs, __ASTRO_IMAGE_IMPORT_ZulDpU, __ASTRO_IMAGE_IMPORT_1inyCS, __ASTRO_IMAGE_IMPORT_MGbyL, __ASTRO_IMAGE_IMPORT_Z1Yq4sn];
  return renderTemplate`<html lang="en" data-astro-cid-sahthylw> <head>${renderComponent($$result, "BaseHead", $$BaseHead, { "title": `Gallery | ${SITE_TITLE}`, "description": "Explore boudoir, artistic nude, body paint, and editorial portrait portfolio categories.", "data-astro-cid-sahthylw": true })}${renderHead()}</head> <body data-astro-cid-sahthylw> ${renderComponent($$result, "Header", $$Header, { "data-astro-cid-sahthylw": true })} <main class="gallery-index" data-astro-cid-sahthylw> <section class="gallery-atmosphere" data-astro-cid-sahthylw> ${renderComponent($$result, "Image", $$Image, { "class": "atmosphere-still", "src": __ASTRO_IMAGE_IMPORT_Z1Yq4sn, "alt": "", "widths": [768, 1280, 1600], "sizes": "100vw", "loading": "eager", "fetchpriority": "high", "quality": 88, "data-astro-cid-sahthylw": true })} <div class="gallery-atmosphere-overlay" data-astro-cid-sahthylw></div> <div class="gallery-lead fade-up" data-astro-cid-sahthylw> <p class="eyebrow" data-astro-cid-sahthylw>Curated For The Bold</p> <h1 data-astro-cid-sahthylw>Every Body Tells A Story. Choose Where Yours Begins.</h1> <p data-astro-cid-sahthylw>
Cinematic boudoir, artistic nude, body-paint, and editorial portrait collections with discreet direction and premium
						visual finish.
</p> <p class="lead-note" data-astro-cid-sahthylw>Sensitive categories use an elegant 18+ confirmation before entry.</p> </div> </section> <section class="gallery-grid fade-up" data-astro-cid-sahthylw> ${GALLERY_CATEGORIES.map((category) => renderTemplate`<a class="category-card"${addAttribute(`/gallery/${category.slug}`, "href")} data-astro-cid-sahthylw> <div class="category-media" data-astro-cid-sahthylw> ${renderComponent($$result, "Image", $$Image, { "src": categoryVisuals[category.slug].image, "alt": `${category.label} teaser`, "widths": [480, 720, 960], "sizes": "(max-width: 760px) 100vw, 50vw", "loading": "lazy", "quality": 82, "data-astro-cid-sahthylw": true })} <div class="category-wash" data-astro-cid-sahthylw></div> </div> <div class="category-content" data-astro-cid-sahthylw> <p class="card-kicker" data-astro-cid-sahthylw>${category.sensitive ? "18+ Category" : "All Audiences"}</p> <h2 data-astro-cid-sahthylw>${category.label}</h2> <p data-astro-cid-sahthylw>${category.description}</p> <p class="category-mood" data-astro-cid-sahthylw>${categoryVisuals[category.slug].mood}</p> <span data-astro-cid-sahthylw>Open Gallery</span> </div> </a>`)} </section> <section class="featured-strip fade-up" aria-label="Featured Work Preview" data-astro-cid-sahthylw> <div class="featured-track" data-astro-cid-sahthylw> ${featuredStrip.map((src) => renderTemplate`${renderComponent($$result, "Image", $$Image, { "src": src, "alt": "Featured work teaser", "width": 440, "sizes": "220px", "loading": "lazy", "quality": 70, "data-astro-cid-sahthylw": true })}`)} ${featuredStrip.map((src) => renderTemplate`${renderComponent($$result, "Image", $$Image, { "src": src, "alt": "Featured work teaser", "width": 440, "sizes": "220px", "loading": "lazy", "quality": 70, "data-astro-cid-sahthylw": true })}`)} </div> </section> <section class="creator-reassurance fade-up" data-astro-cid-sahthylw> <p class="eyebrow" data-astro-cid-sahthylw>Creator Reassurance</p> <h2 data-astro-cid-sahthylw>Private. Empowering. Artistically Directed.</h2> <div class="reassurance-grid" data-astro-cid-sahthylw> <article data-astro-cid-sahthylw> <h3 data-astro-cid-sahthylw>Your Images, Your Control</h3> <p data-astro-cid-sahthylw>Publication permissions stay in your hands with clear boundaries and documented usage.</p> </article> <article data-astro-cid-sahthylw> <h3 data-astro-cid-sahthylw>Discreet Premium Delivery</h3> <p data-astro-cid-sahthylw>Secure transfer workflow for personal galleries, campaign edits, and platform-ready exports.</p> </article> <article data-astro-cid-sahthylw> <h3 data-astro-cid-sahthylw>Creative Direction</h3> <p data-astro-cid-sahthylw>Guided posing and styling that preserves comfort while delivering cinematic, elevated outcomes.</p> </article> </div> </section> <section class="category-cta fade-up" data-astro-cid-sahthylw> <h2 data-astro-cid-sahthylw>Step Into The Studio</h2> <p data-astro-cid-sahthylw>Begin your transformation with a private consultation and a curated concept built around your vision.</p> <a class="btn btn-solid" href="/booking" data-astro-cid-sahthylw>Begin Your Session</a> </section> </main> ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-sahthylw": true })} </body></html>`;
